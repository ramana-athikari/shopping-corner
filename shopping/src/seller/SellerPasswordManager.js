...
const ChangeSellerPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const sellerId = localStorage.getItem("sellerId"); // assuming saved at login
        if (!sellerId) {
        ...
        // 1. Fetch user by ID
        const response = await fetch(`http://localhost:1234/sellerapi/${sellerId}`);
        ...
        // 4. Update password
        const updateRes = await fetch(`http://localhost:1234/sellerapi/${sellerId}`, {
            method: "PATCH",
