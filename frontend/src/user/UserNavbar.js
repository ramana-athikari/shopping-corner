...
const UserHeader = () => {
  ...
  return (
    <nav className="navbar navbar-expand-md mybg sticky-top">
      <div className="container">
        {/* ✅ Brand click fixed */}
        <button onClick={goHome} className="navbar-brand text-white fs-4 btn btn-link text-decoration-none">
          <img
            src="/shopping-icon.png"
            alt="Icon"
            style={{
        ...
        <div className="collapse navbar-collapse text-white" id="navbarTogglerDemo03">
          <ul className="navbar-nav ms-auto">
            ...
            {/* ✅ Home fixed */}
            <li className="nav-item me-4">
              <button onClick={goHome} className="nav-link text-white hover btn btn-link">
                <i className="fa fa-home"></i> Home
              </button>
            </li>
            ...
            {/* ✅ FIX: removed wrong Link */}
            <li className="nav-item me-4">
              <button onClick={switchToSeller} className="nav-link text-white hover btn btn-link">
                <i className="fa fa-shop"></i> Become a Seller
              </button>
            </li>
