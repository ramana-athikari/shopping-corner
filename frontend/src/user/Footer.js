            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-4">
                        ...
                        <p>
                            Shopping Corner is your trusted online store offering quality products at
                            affordable prices. We provide a wide range of items with secure payments,
                            fast delivery, and reliable customer support — making online shopping easy
                            and convenient for everyone.
                        </p>
                    </div>
                    <div className="col-xl-5">
                        <h5 className="text-warning"> Contact Us </h5>
                        <p> #41, 2nd Cross, Outer Ring Road, Bangalore - 560037 </p>
                    ...
                    <div className="col-xl-3">
                        ...
                        {/* fontawesome icons */}
                        <span className="me-2"> <i className="fa-brands fa-square-facebook fs-4 text-white link-warning"></i> </span>
                        <span className="me-2"> <i className="fa-brands fa-square-instagram fs-4 text-white link-warning"></i> </span>
                        <span className="me-2"> <i className="fa-brands fa-square-youtube fs-4 text-white link-warning"></i> </span>
                        <span className="me-2"> <i className="fa-brands fa-linkedin fs-4 text-white link-warning"></i> </span>
